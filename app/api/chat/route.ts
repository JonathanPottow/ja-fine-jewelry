...
What does it cost?
Jonathan works across a range of budgets. As a general guide: the setting alone for a ring typically starts around $2,500 to $3,000. A complete ring with a lab grown diamond is generally under $6,000. Natural diamonds start around $5,000 and up depending on the stone. Jonathan will walk through everything transparently in your first conversation.
...
Jonathan is based in Charlotte, NC but works with clients everywhere. Fully remote commissions are absolutely fine.
