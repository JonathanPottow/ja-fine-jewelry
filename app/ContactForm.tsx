...
const PIECE_TYPES = [
  {
    ...
    icon: '◇',
    placeholder: "Tell Jonathan about your partner, your love story, and the vision you have for the ring. Any style inspirations, stone preferences, or budget in mind?",
  },
  {
    label: 'Wedding Band',
    icon: '○',
    placeholder: "Describe the look you're going for — classic, modern, diamond-set, plain? Will it be paired with an existing ring? Any metal preferences?",
  },
  {
    label: 'Anniversary Piece',
    icon: '✦',
    placeholder: "What milestone are you celebrating? Tell Jonathan about the person and what would make this piece meaningful to them.",
  },
  {
    label: 'Pendant',
    icon: '◈',
    placeholder: "What's the inspiration for this pendant? A symbol, a stone, a memory? Share as much or as little as you'd like.",
  },
  {
    label: 'Heirloom Redesign',
    icon: '❧',
    placeholder: "Tell Jonathan about the piece you'd like reimagined — what it is, who it belonged to, and how you'd like to honor that legacy in the new design.",
  },
  {
    label: 'Something Else',
    icon: '◦',
    placeholder: "Describe what you have in mind — Jonathan works on all kinds of bespoke commissions and loves a unique challenge.",
  },
]
...
function ContactForm() {
  ...
  const storyPlaceholder = selectedPiece?.placeholder || "Tell Jonathan about your vision, the occasion, and the person who will wear this piece..."
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      {/* Rest of form slides in once piece selected */}
      <div className={form.piece ? styles.formFields : styles.formFieldsHidden}>
        ...
        <div className={styles.formGroup}>
          ...
          <input type="tel" required placeholder="Your number" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} />
        </div>
        <div className={styles.formGroup}>
        ...
        {/* File upload */}
        <div className={styles.formGroup}>
          <label>Inspiration or Reference Images (optional)</label>
          <div
            className={dragOver ? `${styles.uploadZone} ${styles.uploadZoneActive}` : styles.uploadZone}
